...
def build_parser() -> argparse.ArgumentParser:
    ...
    preview_parser = subparsers.add_parser("preview", help="Preview project analysis")
    preview_sub = preview_parser.add_subparsers(dest="preview_action", required=True)

    analysis_preview = preview_sub.add_parser("analysis", help="Preview a sample analysis output")
    analysis_preview.add_argument(
        "zip_path",
        nargs="?",
        default=None,
        help="Optional path to a zip archive; if omitted, a sample project will be generated."
    )
